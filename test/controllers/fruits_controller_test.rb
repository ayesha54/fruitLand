...
class FruitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fruit" do
    assert_difference('Fruit.count') do
      post fruits_url, params: { fruit: { description: @fruit.description, expire_date: @fruit.expire_date, name: @fruit.name, price: @fruit.price } }
    end
  ...
  test "should update fruit" do
    patch fruit_url(@fruit), params: { fruit: { description: @fruit.description, expire_date: @fruit.expire_date, name: @fruit.name, price: @fruit.price } }
